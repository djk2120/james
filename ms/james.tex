...
\section{Figures}
  \begin{figure}[h]
     ...
     \caption{Modeled vegetation water potential at  Caxiuan\~a national forest, Brazil.
...
\clearpage   
  \begin{figure}[h]
     ...
     (b) Time-series of SMS inferred soil-to-leaf conductance (s$^{-1}$)  from Soil Layer 3.
