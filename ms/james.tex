...
The potential drop from predawn to midday root water potential increases from 0.058 MPa in the ambient simulation to 1.12 MPA with TFE.
Therefore TFE causes the drop in root water potential to increase by 1.06 MPa.
...
Stem drop actually abates, smaller because though PLC increases, transpiration decreases to larger effect.
...
for PHS vs. SMS with ambient and 60\% excluded throughfall conditions.
...
\clearpage   
  ...
  \end{figure}
    ...
    \begin{figure}[h]
     ...
     Panel (a) shows the cumulative profile of daytime root water uptake (mm/s) for the four simulations during SON-2003.
  ...
  \end{figure}
    ...
    \begin{figure}[h]
     ...
     Panel (a) shows the cumulative profile of daytime root water uptake (mm/s) for the four simulations during FMA-2003.
