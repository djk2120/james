...
\subsection{Soil moisture}
    ...
    Partly this is a difference in transpiration, PHS has 2.4 and 1.5 \% more column total soil water in amb/tfe, respectively.
    The other difference is PHS extracts deeper.
    ...
    The SMS water stress factor also depends on $\psi_c$.
...
\section{Supplementary Figures}
  ...
  \clearpage
    ...
    \begin{figure}[h]
     \centering
     \includegraphics[width=30pc]{../figs3/supplayer2.pdf}
     ...
     With PHS (black line), the soil layer can dry out more quickly after rain events.}
     \label{supp:layer2}
  \end{figure}
  ...
  \clearpage
    ...
    \begin{figure}[h]
     \centering
     \includegraphics[width=30pc]{../figs3/suppsmp.pdf}
