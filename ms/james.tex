...
hydraulic conductance based on xylem vulnerability and soil hydraulics.
...
main points working towards:
\begin{itemize}
\item soil water sensitivity
\item compensatory RWU
\item better model structure
\item SMS dry bias
\item SMS non-linearity
\end{itemize}

PHS is more sensitive to soil water.


End with non-linearity
