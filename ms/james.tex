...
Understanding vegetation response is a high priority, especially within Amazonia.
...
Advancing the representation of the SPAC introduces a new state variable to models, vegetation water potential.
