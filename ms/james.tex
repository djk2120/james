...
tfe monthly total HR is highly correlated with monthly total precipitation (R =0.968)
compare to amb (R= -0.172)

correlation with monthly mean predawn root water potential are in opposite directions
tfe (R=0.882),
amb (R=-0.700)

tfe multiple linear regression has precip significant (p<<0.01), predawn potential insignificant (p=0.18), R2 = 0.94 (only precip)
amb has both significant positive association with precip, negative association with predawn water potential, ie drier soils more HR, more rain more HR R2 = 0.77 (both)

Supp Figure \ref{supp:hr}
HR predominately downwards during wet season (FMA), both for TFE and AMB.
HR predominately upwards during dry season (SON) for TFE
HR in both directions during dry season (SON) for AMB
