...
\clearpage   
  ...
  \end{figure}
    ...
    \begin{figure}[h]
     ...
     \caption{Dry season (SON), daytime (6am to 6pm) average root water uptake profiles with depth. 
     Panel (a) shows cumulative (starting at depth) root water uptake (mm/s) for the four simulations.
  ...
  \end{figure}
    ...
    \begin{figure}[h]
     ...
     \caption{Wet season (FMA), daytime (6am to 6pm) average root water uptake profiles with depth. 
     Panel (a) shows cumulative (starting at depth) root water uptake (mm/s) for the four simulations.
     Panels (b)-(e) present the information from (a) in non-cumulative form. 
     Note that negative root water uptake is shaded red. }
     \label{fig8}
  \end{figure}
