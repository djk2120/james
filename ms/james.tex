...
Big changes: introduce a new mode of variability to water stress, and upend the model for root water uptake.
This has significant effects on diffusive fluxes and soil moisture.
...
Field measurements of hydraulic traits will help, but mostly only aboveground.
Flux observations can help to tune stress parameters.
But what's challenging is the underground parameterization.
We don't have a lot of hydraulic trait data, and we don't have a lot of vertically resolved soil moisture.
