...
PHS introduces dynamic vegetation water potential, for the first time, into the default configuration of the CLM.
...
The dynamism in the gradient of water potential from soil-to-leaf, according to Darcy's Law, should drive RWU \citep{jarvis2011}.
A mechanistic representation of this process is important for modeling the range of water use strategies, and/or testing hypotheses regarding these on the ESM scale, such as the effects of iso/anisohydry on leaf gas exchange and drought vulnerability.
...
Hydraulic theory describes soil conductance as featuring an exponential relationship with soil potential \citep{brooks1964}, ranging three orders of magnitude over the range of soil potential observed in our simulations.
