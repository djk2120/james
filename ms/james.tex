...
With PHS, RWU is more sensitive to soil potential (Figure \ref{fig:rwu}), decreasing sharply as soils dry.

while this is one site and subject to the exact parameter values, the result is likely generalizable given the values on the CLM parameter file for $\psi_c$, which range from -2.2 to -4.2 MPa \citep{oleson2013}.
hydraulic conductance based on xylem vulnerability and soil hydraulics.
soil conductivity declines by 3 orders of magnitude 
