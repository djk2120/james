...
\subsection{Stress factor}
    ...
    While average midday stress values are comparable during the 2003 dry season (Figure \ref{fig:stress1}) between the two model configurations, 
    PHS achieves more photosynthesis (Supp Fig \ref{supp:fpsn}), due to the lower stress in the mornings and afternoons.
