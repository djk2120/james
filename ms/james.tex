...
As above, leaf water potential is used to effect drought stress for the photosynthesis/stomatal conductance routines.
...
I'm interested in seeing this straight Darcy style parameterization studied further. 
...
it becomes hard to justify all the added degrees of freedom in the PHS RWU vector.
But PHS is exciting because it opens a frontier for actually getting better at this, and for learning about the system along the way.
In parallel, I do think pursuing an improved heuristic, with somewhat limited DOF, is very worthwhile.
