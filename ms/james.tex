...
\subsection{The extensive influence of $\psi_c$}
    ...
    This non-linearity of root water uptake tends to make soil potential decrease to and then hold at $\psi_c$ (Figure \ref{fig:sm}).
    As such, $\psi_c$ has strong influence on both transpiration and soil moisture, despite limited empirical or physical basis \citep{rogers2017}.
