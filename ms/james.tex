...
\subsection{The promise of plant hydraulics}
    ...
    The looming concern has been added complexity \citep{verhoef2014}, so we installed a simplified model (see Section zqz).
...
\clearpage   
  ...
  \end{figure}
    ...
    \begin{figure}[h]
     \centering
     \includegraphics[width=30pc]{../figs3/hr2.pdf}
     \caption{Total hydraulic redistribution (cm) by month across in 2002 and 2003. For (a) ambient through-fall conditions, and (b) 60\% through-fall exclusion. 
  ...
  \end{figure}
              ...
              \begin{figure}[h]
     \centering
     \includegraphics[width=30pc]{../figs3/t_vs_smp.pdf}
