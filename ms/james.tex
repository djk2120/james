...
Plant hydrodynamic parameterizations are important in Earth System Models, calculating water use through time.
Vegetation water use strategies modulate carbon uptake, creating a critical coupling between the Earth System's carbon and hydrological cycles.
Within models drought stress parameterizations are used to define a notion of vegetation water status 
that is used to modulate transpiration, photosynthesis, and root water uptake. 
