...
over the three-year simulation with PHS on and off under both ambient and 50\% excluded throughfall conditions.

In the ambient throughfall experiment, PHS-off has no stress (Fig \ref{fig:mm}b, solid line). 
PHS-on has significant stress, ranging from 0.6 to 0.9 (Fig \ref{fig:mm}a, solid line).
...
As a result, PHS-on has less GPP than off, and less seasonality in GPP. 
For 2003, PHS-on GPP was 279 g/m2/y (9\%) less than PHS off.
Likewise for transpiration, which is less on than off by 93 mm (7\%) over 2003.
