...
Leaf water potential shows the typical diurnal drop, reaching -1.65 MPa at midday (Figure \ref{fig:vwp}a).
...
Stem, shade, and leaf curves are all roughly equal, resulting in overlapping lines in Figure \ref{fig:vwp}a, resulting from minimal stem-to-leaf resistance in the parameter values used in this experiment.
As such, stem-to-leaf resistance is not fully deployed presently, but may be important to investigate further, given the diversity of leaf form and function \citep{sack2002}. 
    ...
    Despite reduced stem conductance, the pressure drop from root-to-stem actually decreases to -1.02 MPa (from -1.47 MPa), following from 54\% reductions in transpiration.
