...
\label{sect:rwu}
    ...
    The vertical profile of root water uptake rate (mm/s) is presented in Figure \ref{fig7}a, averaged over the 2003 dry season (SON). 
    PHS simulations (black color), feature more surface extraction than with SMS, especially under ambient throughfall conditions (Fig\ref{fig7}a).
