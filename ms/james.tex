...
Neither gets TFE, but PHS looks nice compared to sap flux.
...
PHS introduces diurnal cycle to stress factor (Figure \ref{fig4}). This follows the diurnal cycle in leaf water potential (e.g. Figure \ref{fig:vwp}a,b).

Transpiration demand responds to solar radiation (through photosynthesis) and to vpd.

stress factor backs off medlyn conductance
because medlyn conductance is chill at night, 1 it is.
