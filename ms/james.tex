...
ambient,
PHS more surface extraction. net extraction is zero beyond about 85 centimeters
SMS gets more than half its water from beyond 1 meter in depth.

tfe,
PHS surface extraction increases, in service of some downward HR.
note that HR is not going to depth, but rather to between 0.32 and 4.64m in depth.
there is actually extraction beyond 4.64 meters (albeit minimal, 6.7 mm over the 89 days)
