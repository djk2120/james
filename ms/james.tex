...
Model structural information
  ...
  e.g. medlyn wants a hydraulic constraint, opens up darcy root water uptake
  
Our goal:
  - simplified plant hydraulic implementation
  - setting a framework to represent vegetation water potential, which
  (1) is pretty appealing as the functional argument for several land surface processes
  (2) generates an interface to trait data, in situ observations of water potential, and satellite VOD \citep{momen2017}
