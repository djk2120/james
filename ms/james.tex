...
%Water demand
    ...
    Because leaf water potential is modeled separately for sunlit and shaded leaves, $f_w$ takes on distinct sunlit and shaded values.
     ...
     neglecting non-linear components of the relationship between stress and transpiration (described further in Appendix Section B.1).
...
\subsection{Can modeling vegetation water potential improve the CLM?}
    ...
    While this is encouraging, especially given the nature of the previous bias (see Section \ref{sect:smpt}), the improvement is specific to the site and experiment described herein, and model skill will need to be re-evaluated in a broader context.
