...
This site features a critical biome (terra-firme moist tropical evergreen forest) subject to experimental throughfall exclusion, where we expect vegetation regulation of transpiration and photosynthesis.
...
\label{sect:rwu}
    ...
    PHS and SMS feature very different root water uptake dynamics.
    ...
    This explains the response in near-surface water uptake to rain events and to TFE.
    PHS features increases in near-surface water uptake after rain and decreases with TFE.
    SMS near-surface water uptake is less sensitive to rain events and increases with TFE.
    Root water potential is not so negative as \psi_c.
    PHS conductances decrease with drying.
