...
Because SMS does not resolve water potential through the vegetation substrate, the model instead uses a constant parameter, $\psi_c$ to define the hydraulic gradient.
