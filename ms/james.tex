...
Outside the PHS iteration
    ...
    \begin{equation}
    \begin{aligned}
    E_{sun} &=   g_{s,sun}*\rho*\text{VPD}*laisun*\left(1+\dfrac{g_{s,sun}}{g_b}\right)^{-1} \\
    E_{shade} &=   g_{s,shade}*\rho*\text{VPD}*laishade*\left(1+\dfrac{g_{s,shade}}{g_b}\right)^{-1}
    \end{aligned}
    \end{equation}
    
Inside the PHS iteration
    \begin{equation}
    \begin{aligned}
    E_{sun} &=   E_{sun,max}*2^{-\left(\dfrac{\psi_{\text{leaf}}}{\psi_{50}}\right)^{c_k}} \\
    E_{shade} &=   E_{shade,max}*2^{-\left(\dfrac{\psi_{\text{leaf}}}{\psi_{50}}\right)^{c_k}}
    \end{aligned}
    \end{equation}
    
Where we return $f_w$ as
    \begin{equation}
    \begin{aligned}
