...
This is not a skill paper, but I can't not show/comment on overall results.
Basically need to show stress function. Top = stress function
...
\section{Figures}
  ...
  \begin{figure}[h]
     ...
     \caption{Monthly mean transpiration and gross primary productivity. 
     Solid lines correspond to ambient throughfall conditions, and dotted lines correspond to 50\% throughfall exclusion.
     Black lines represent model output.
     Red lines show observational transpiration derived from sap flux (see zqz).
     PHS is on for (a) and (c). PHS is off for (b) and (d).
     Note that throughfall exclusion begins January 2002.
     }
     \label{fig3a}
  \end{figure}
