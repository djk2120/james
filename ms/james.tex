...
SMS tends to make larger errors modeling transpiration (Figure \ref{fig:t2}g). 
The absolute value of SMS-OBS exceeds 1 mm/d in 67 of the 414 days with available observations, as compared to just 23 with PHS.
...
The major limitation of the PHS simulation is that it seems to underestimate transpiration variability, with a standard deviation of 0.61 mm/d compared to 0.87 mm/d in the observations.
This contributes to a low bias for high transpiration values and a high bias for low transpiration values (Figure \ref{fig:t}c).
...
This has precedent, as previous studies have demonstrated that the effect of TFE is not captured well by the CLM (nor other DGVMs) \citep{restrepo2017,powell2013}.
...
\subsubsection{Soil Moisture, Ambient Conditions}

\subsubsection{Soil Moisture, TFE}
