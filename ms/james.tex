...
looking at layer 7, conductance is zero from nov22 through the end of the year
...
Total extraction from this layer in daytime SON 2003 is 4.24 cm.
With PHS-off, the most extraction is from layer 8 (68 to 92 cm).
...
The correlation between PHS-on average root sink and root fraction is R = 0.47.
...
with a net daytime sink of 11.0 cm of water from layers 15-20 (beyond 3.26 meters). 
With PHS-off there is 5.9 cm of water extracted from those layers.
deep roots \citep{nepstad1994}

As a result (during TFE) there is more dry season transpiration (SON) with PHS on, 32.1 cm vs. 29.2 cm with PHS off.
...
After rain events, (there is 26cm of rain in SON2003), root water uptake rates can run as high as 1.02e-4 mm/s in layer 2.

For a sense of scale, at this rate the full saturated water volume from layer 2 (0.66*4cm) can be taken up by the roots in about 72 hours.
With PHS off, the fastest root water uptake is 2.7e-5 mm/s from layer 9. This is smaller and occurs from a larger soil layer (spans 92 to 120cm depth).
With PHS off, the fastest root water uptake relative to the layer size is from layer 1, 4.3e-6 mm/s, 
which would take approximately 850 hours to process the saturated layer water volume. 
...
HR increases from 408mm in the ambient simulation to 563 mm with TFE.
HR is predominately at night, ambient is 307/101, TFE is 401/163. 
Slight shift towards daytime with TFE 29\% daytime compared to 25\% daytime.
With TFE, HR is highly correlated to precipitation, with R=0.97 between monthly total precip and HR.
