...
\section{Introduction}
 ...
 - droughts are increasing, but controversial 
      . \citep{cook2015}
      . \citep{dai2013}
...
\label{sect:btran}
    ...
    Likewise the values for $\psi_{c}$ are very low. 
    
    (2) Conductance dynamics \\
    Instead, intra-day SMS soil sink dynamics derive from a highly dynamic conductance.
    ...
    Likewise SMS ignores that hydraulic conductance generally scales with the inverse of conducting length.
