...
\section{Figures}
  \begin{figure}[h]
     ...
     (a) Ambient throughfall conditions (b) 70\% throughfall excluded
     }
     \label{fig2}
  \end{figure}
\clearpage   
  \begin{figure}[h]
     ...
     (b) PHS-on, Jan 1, 2002 to Dec 31, 2003 with 70\% throughfall excluded.
     (c) PHS-off, ambient throughfall, all timesteps.
     (d) PHS-off, Jan 1, 2002 to Dec 31, 2003 with 70\% throughfall excluded.
     }
     \vspace{3.0em}
     \includegraphics[width=30pc]{../figs/fig3a.pdf}
     \caption{Inset for Figure 3b, showing median daytime conductance during TFE
     }
     \label{fig3a}
  \end{figure}
  \clearpage
    \begin{figure}[h]
     ...
     \caption{Total hydraulic redistribution (mm) by month over two years (2002-3). For (a) ambient throughfall conditions, and (b) 70\% throughfall exclusion.      }
     \label{fig2}
  \end{figure}
    ...
    \begin{figure}[h]
     ...
     \caption{PHS-on, Nighttime (6pm to 6am)  soil sink by layerfor 
     (a) September 2001-3, ambient throughfall,
     (b) December 2001-3, ambient throughfall,
     (c) September 2002-3, 70\% throughfall excluded,
     (d) December 2002-3, 70\% throughfall excluded. 
  ...
  \end{figure}
    ...
    \begin{figure}[h]
     ...
     \caption{PHS-on, Daytime (6am to 6pm) soil sink by layer for 
     (a) September 2001-3, ambient throughfall,
     (b) December 2001-3, ambient throughfall,
     (c) September 2002-3, 70\% throughfall excluded,
     (d) December 2002-3, 70\% throughfall excluded. 
  ...
  \end{figure}
    ...
    \begin{figure}[h]
     ...
     \caption{PHS-off, Daytime (6am to 6pm) soil sink by layer for 
     (a) September 2001-3, ambient throughfall,
     (b) December 2001-3, ambient throughfall,
     (c) September 2002-3, 70\% throughfall excluded,
     (d) December 2002-3, 70\% throughfall excluded. }
  ...
  \end{figure}
    ...
    \begin{figure}[h]
     ...
     (b) PHS-on, 70\% throughfall excluded
     (c) PHS-off, ambient throughfall
     (d) PHS-off, 70\% throughfall excluded. 
     For (a) and (b) data are subdivided based on predawn root water potential; blue dots represent the highest tercile, yellow dots represent the intermediate tercile, and red dots represent the most negative tercile.
     For (c) and (d) data are subdivided based on average soil matric potential, weighted by root fraction; blue dots represent the highest tercile, yellow dots represent the intermediate tercile, and red dots represent the most negative tercile.
     }
     \label{fig2}
  \end{figure}
